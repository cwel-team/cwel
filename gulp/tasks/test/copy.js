...
// @internal
gulp.task('cwel-test-copy-vendor', () => gulp.src('Cwel/Test/e2e/vendor/**/*.js')
.pipe(gulp.dest('Cwel/tmp/test/Testing/vendor')));
// @internal
gulp.task('clean:cwel-test-copy-vendor', () => del(['Cwel/tmp/test/Testing/vendor/**/*.js']));
