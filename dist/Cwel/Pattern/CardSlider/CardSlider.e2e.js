...
"use strict";
var CardSliderPageObject=__webpack_require__(1).default;describe('CardSlider',function(){var a,b='/pattern/cardslider';beforeEach(function(){a=new CardSliderPageObject}),it('should decrease offset by one when clicking the previous button',function(c){a.navigate(b),a.getIndex().then(function(b){expect(b).toBe(1),a.clickPrev(),a.getIndex().then(function(a){expect(a).toBe(0),c()})})}),it('should increase offset by one when clicking the next button',function(c){a.navigate(b),a.getIndex().then(function(b){expect(b).toBe(0),a.clickNext(),a.getIndex().then(function(a){expect(a).toBe(1),c()})})}),it('wont allow the offset to go beyond the last slide',function(){a.navigate(b),a.clickNext(),a.getIndex().then(function(a){expect(a).toBe(1)})}),it('Wont allow the offset to go below the first slide',function(){a.navigate(b),a.clickPrev(),a.getIndex().then(function(a){expect(a).toBe(0)})})});
...
/***/ })
/******/ ]);
//# sourceMappingURL=CardSlider.e2e.js.map