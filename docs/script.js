...
"use strict";
var _createClass=function(){function a(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,'value'in c&&(c.writable=!0),Object.defineProperty(a,c.key,c)}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}();__webpack_require__(54);var _site=__webpack_require__(68),_site2=_interopRequireDefault(_site);__webpack_require__(73);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError('Cannot call a class as a function')}var contentful=__webpack_require__(74),marked=__webpack_require__(190),prism=__webpack_require__(25),htmlEscapeToText=function(a){return a.replace(/\&\#[0-9]*;|&amp;/g,function(a){return a.match(/amp/)?'&':String.fromCharCode(a.match(/[0-9]+/))})},render_plain=function(){var a=new marked.Renderer;return a.code=function(a,b){var c=Prism.highlight(a,Prism.languages[b]||'');return'<pre ng-non-bindable><code class="language-'+b+'">'+c+'</code></pre>'},a.table=function(a,b){return'\n        <table class="table">\n            <thead>'+a+'</thead>\n            <tbody>'+b+'</tbody>\n        </table>'},a.link=function(a,b,c){return'<a href="'+a+'">'+c+'</a>'},a.paragraph=function(a){return htmlEscapeToText(a)+'\r\n'},a.heading=function(a,b){return 1==b?'<h1 class="h1"><span class="h1__text">'+a+'<span></h1>':2==b?'<h2 class="h2"><span class="h2__text">'+a+'</span></h2>':3==b?'<h3>'+a+'</h3>':4==b?'<h4>'+a+'</h4>':void 0},a.image=function(){return''},a};function markedRender(a){return marked(a,{renderer:render_plain()})}_site2.default.controller('docs',['$scope',function(a){a.date=new Date}]),_site2.default.directive('navitem',['$rootScope',function(){return{scope:{text:'=',items:'=',name:'=',filter:'='},templateUrl:'shared/layout/nav-item.html',link:function link(){}}}]);var client=contentful.createClient({space:'yxnc72m9rwc9',accessToken:'becc6f5bad7201fc61c75cca9ef657609a3599aae89b5cd5ed215f9f7656cdca',resolveLinks:!0});_site2.default.service('contentful',['$rootScope',function(a){var b=function(){function b(){_classCallCheck(this,b)}return _createClass(b,[{key:'getContentTypes',value:function getContentTypes(b){client.getContentTypes().then(function(c){a.$applyAsync(function(){return b(c.items)})}).catch(console.error)}},{key:'getPageData',value:function getPageData(b,c,d){client.getEntries({content_type:c,"fields.name":b}).then(function(b){a.$applyAsync(function(){return d(b.items[0].fields)})}).catch(console.error)}},{key:'getPageLinks',value:function getPageLinks(b){client.getEntry('2xvviTT5768UOcCMYwskCA').then(function(c){client.getEntries({content_type:'component',select:'fields.name,fields.title'}).then(function(d){a.$applyAsync(function(){var a=c.fields.config,e=!0,f=!1,g=void 0;try{for(var h,i,j=a[Symbol.iterator]();!(e=(h=j.next()).done);e=!0)i=h.value,'component'===i.name&&(i.items=d.items.map(function(a){return a.fields.text=a.fields.title,a.fields}))}catch(a){f=!0,g=a}finally{try{!e&&j.return&&j.return()}finally{if(f)throw g}}b(a)})}).catch(console.error)}).catch(console.error)}}]),b}();return new b}]),_site2.default.controller('content',['$scope','$stateParams','contentful',function(a,b,c){c.getPageData(b.name,b.type||'guide',function(c){a.markedRender=markedRender,a.title=c.title,a.body=c.body,a.type=b.type})}]),_site2.default.controller('component',['$scope','$stateParams','contentful',function(a,b,c){c.getPageData(b.name,'component',function(c){if(a.markedRender=markedRender,a.name=c.name,a.title=c.title,a.type='component',a.items=['code','usage','design','service'],a.tabVisible=function(b){a.hideTab=!c[b]},!b.tab)for(var d=0;d<a.items.length;d++)if(null!=c[a.items[d]])return a.activeTab=a.items[d],void(a.body=c[a.items[d]]);a.body=c[b.tab]})}]),_site2.default.controller('navRender',['$scope','contentful',function(a,b){a.pages=[],b.getPageLinks(function(b){a.pages=a.pages.concat(b)})}]),_site2.default.config(['$stateProvider','$urlRouterProvider','$qProvider',function(a,b,c){b.otherwise('/'),a.state('component',{url:'/component/:name',templateUrl:'./templates/component',controller:'component'}).state('tab',{url:'/component/:name/:tab',templateUrl:'./templates/component',controller:'component'}).state('nested',{url:'/:type/:name',templateUrl:'./templates/content',controller:'content'}).state('page',{url:'/{name:[^/]+}',templateUrl:'./templates/content',controller:'content'}).state('landing',{url:'/',templateUrl:'./templates/landing',controller:function controller(){}}),c.errorOnUnhandledRejections(!1)}]);
